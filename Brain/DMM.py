...
def Mixtral7B(prompt,instructions,temperature=0.1,max_new_taken=2,top_p=0.95,repitons_penalt=1.0):
    data = {'prompt' : prompt,
...
def L1_X_L2(query):
    ...
    if L1_response=="Query":
        ...
        print("It is a Automation")

while True:
    print(L1_X_L2(input("Enter Your Prompt : ")))